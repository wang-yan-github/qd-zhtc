 ...
 */
@Component
public class BootNettyServerParking {
    private static class BootNettyServerInit {
        static final BootNettyServerParking INSTANCE = new BootNettyServerParking();
    }

    public static BootNettyServerParking getInstance() {
        return BootNettyServerInit.INSTANCE;
    }
    ...
    public void bind(int port) throws Exception {
        ...
        try {
             ...
             */
            serverBootstrap = serverBootstrap.childHandler(new BootNettyChannelInitializerParking<SocketChannel>());
    ...
    public static void main(String[] args) throws Exception {
        BootNettyServerParking server = new BootNettyServerParking();
        server.bind(8888);
        System.out.println("tcp 8888 端口开启成功");
    }
}
