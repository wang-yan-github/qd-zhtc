                                ...
                                <div class="layui-table-body layui-table-main section-scroll">
                                    <table class="layui-table" >
                                        ...
                                        <tr>
                                            ...
                                            <th class="table-th-css"><div align="center">路侧名称</div>
                                            </th>
...
<script type="text/javascript" src="/sjfx/js/echart/pages/parking.js"></script>
