...
columnChartOption2.series[0].itemStyle.normal.barBorderRadius = 5;
...
pieChartOption.series.center = scrWidth > 1400 ? ['50%', '62%'] : ['45%', '53%'];
...
pieChartOption.legend.top = scrWidth > 1400 ? "2%" : "0px";
...
huan_pieChartOption.series.radius = scrWidth > 1400 ? ['30%', '50%'] : ['35%', '58%'];
huan_pieChartOption.series.center = scrWidth > 1400 ? ['50%', '55%'] : ['45%', '56%'];
huan_pieChartOption.legend.show=false;
huan_pieChartOption.legend.orient='horizontal';
huan_pieChartOption.legend.textStyle.fontSize=14;
//huan_pieChartOption.legend.data=scrWidth > 1400 ? ['支付宝', '微信', '现金'] : "false";
huan_pieChartOption.legend.top = scrWidth > 1400 ? "2%" : "0px";
huan_pieChartOption.legend.left = scrWidth > 1400 ? "center" : "0px";
...
rankingChartOption1.series[0].itemStyle.normal.barBorderRadius = 5;
