...
function getCarTop5Data() {
    $.ajax({
        ...
        success: function (res) {
            ...
            stopCarFiveLineOption.yAxis[0].data = top5CarStopList;
            stopCarFiveLineOption.yAxis[1].data = top5CarStopData2;
