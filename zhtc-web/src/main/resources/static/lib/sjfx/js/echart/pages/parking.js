...
columnChartOption.yAxis.name = "车辆数/停车场";
columnChartOption.grid = grid0;
columnChartOption.title.show = false;
columnChartOption.tooltip.formatter = "停车场：{b}<br>数量：{c}辆";
...
columnChartOption1.yAxis.name = "数量/停车场";
...
columnChartOption1.tooltip.formatter = "停车场：{b}<br>数量：{c}辆";
...
rankingChartOption.title.text = "各停车场收费总额排名TOP5";
...
rankingChartOption.yAxis.name = "TOP5 停车场";
rankingChartOption.tooltip.formatter = "停车场：<b style='font-size: 16px;'>{b}</b><br>金额：<b style='line-height: 1.3;font-size: 16px;'>{c}元</b>";
...
lineChartOption1.title.text = "各停车场今日收费总额趋势分析";
