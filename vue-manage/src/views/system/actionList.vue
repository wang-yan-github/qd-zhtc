        ...
        <div class="container">
            <div class="handle-box">
                <div class="left-panel">
                    <el-button v-permission="['road_actionzn_add', 'park_actionzn_add']" type="primary" size="small"
                        icon="el-icon-plus" @click="handleEdit(0, null, true, null)">添加
                    </el-button>
                    <el-button v-permission="['park_actionzn_deleteAll', 'road_actionzn_deleteAll']" type="danger"
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" :max-height="tableH"
                ...
                <el-table-column label="操作" width="220" align="center">
                    <template #default="scope">
                        ...
                        <el-button v-permission="['road_actionzn_edit', 'park_actionzn_edit']" size="mini" type="text"
                            icon="el-icon-edit" @click="handleEdit(scope.$index, scope.row, false)">编辑
                        </el-button>

                        <el-button v-permission="['road_actionzn_delete', 'park_actionzn_delete']" size="mini" type="text"
