    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                <div class="left-panel">
                    <el-button
                            ...
                            size="small"
                            icon="el-icon-plus"
                            @click="handleAdd(0, null, true)"
                            v-permission="'road_monthSetA_add'"
                    >添加
                    </el-button
                    >
                    <el-button
                            ...
                            v-permission="'road_monthSetA_deleteAll'"
                    >批量删除
                    </el-button
                    >
                </div>
            ...
            >
                ...
                <el-table-column prop="roads" label="路内" align="center">
                    <template #default="scope">
                        <div class="no-warp">
              <span v-for="(item, index) in scope.row.roadList">
                <el-tag
                        size="small"
                        :key="index"
                        v-if="item !=null"
                        ...
                        class="mar5 mb5"
                >{{ item==null || item.road_name==null ? "":item.road_name }}</el-tag>
              </span>
                        </div>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="操作" width="180" align="center">
                    <template #default="scope">
                        <el-button
                                ...
                                v-permission="'road_monthSetA_edit'"
                        >编辑
                        </el-button>
                        <el-button
                                size="mini"
                                ...
                                v-permission="'road_monthSetA_delete'"
                        >删除
                        </el-button
                        >
                    </template>
        ...
        <el-dialog :title="dialogT" v-model="addVisible" width="800px" top="5vh">
            <el-form label-width="70px" label-position="top" size="small" :rules="formRules" ref="addform"
                ...
                <!-- <el-form-item label="包月时间段(全天00:00-24:00)(周末全天包月)：">
                  <el-row>
                    <el-col :span="11"
                      ><el-time-picker
                        placeholder="选择时间"
        ...
        <!-- 详情弹出框 -->
        <el-dialog title="路内列表" v-model="viewVisible" width="840px" @close="closeAddress">
    ...
    export default {
        ...
        setup() {
            ...
            const handleView = (index, row) => {
                ...
                let roadsList = [];
                row.roadList.forEach(function (item) {
                    if (item != null) {
