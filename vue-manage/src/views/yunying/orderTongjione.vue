    ...
    <div>
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="roadName" align="center" label="停车场" v-if="menuType == '1'"></el-table-column>
                <el-table-column prop="roadName" align="center" label="路内" v-if="menuType == '0'"></el-table-column>
                ...
                <el-table-column prop="totalPayment" label="缴费总量" width="200" align="center">
                </el-table-column>
            </el-table>
...
<script>
    ...
    import {
        getRoadParkingOrderBasicData,
        exportOrderBasicData,
        queryAreaData,
        queryStreetData,
        queryRoadData,
        queryParkData,
    ...
    export default {
        ...
        setup() {
            ...
            // 获取表格数据
            const getData = () => {
                getRoadParkingOrderBasicData(query).then((res) => {
            ...
            //导出excel
            const exportExcel = () => {
                exportOrderBasicData(query).then((res) => {
                    const url = window.URL.createObjectURL(new Blob([res]))
                    const link = document.createElement('a')
                    link.href = url
                    link.setAttribute('download', '订单统计.xls')
