    ...
    <div>
                ...
                <div class="right-panel">
                    <el-form inline size="small">
                        ...
                        <el-form-item class="mb0">
                            ...
                            <el-button size="small" type="success" @click="exportshensu" icon="el-icon-upload2"
                                       v-permission="'road_shensuorder_excel'"
                            >导出
                            </el-button>
                        </el-form-item>
                    </el-form>
                ...
                <el-table-column label="操作" width="120" align="center">
                    <template #default="scope">
                        <el-button
                                ...
                                v-permission="'road_shensuorder_sh'"
                        >审核
                        </el-button>
                    </template>
                </el-table-column>
        ...
        <span class="dialog-footer">
          ...
          <el-button
                  ...
                  v-if="detailsData.records == null"
          >处理申诉</el-button
          >
          <el-button type="info" @click="noticeFeedback"
          >通知巡检员反馈</el-button
          >
        </span>
            </template>
