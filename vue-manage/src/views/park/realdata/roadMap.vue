<template>
  <div style="height: 100%">
    <div id="mapDiv" style="height: 100%">
      <div id="has-map" class="has-map" ref="has-map" />
    </div>
...
import { loadInitTMap, creatMarker } from "../../../plugins/loadinitTmap";
import { ParkGPCountList } from "../../../api";
...
export default {
  ...
  setup() {
    ...
    const getParkGPCount = () => {
      ParkGPCountList(reactive({})).then((res) => {
