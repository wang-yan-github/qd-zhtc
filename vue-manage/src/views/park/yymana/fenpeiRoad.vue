<template>
  <div>
    <div class="container">
      ...
      >
        ...
        align="center"
          ...
          width="130"
        ></el-table-column>
        <el-table-column label="泊位数量" align="center" width="100">
        </el-table-column>
        <el-table-column label="分配人数" align="center" width="100">
        </el-table-column>
        <el-table-column label="负责巡检员" prop="name" align="center">
          <template #default="scope">
            <el-tag
              effect="dark"
              size="small"
              v-for="(item, index) in scope.row.purviews"
              :key="index"
              class="mar5"
              >{{ item }}</el-tag
            >
    ...
    <!-- 编辑弹出框 -->
    <el-dialog title="解绑收费员" v-model="editVisible" width="40%">
      <el-table
        :data="tableData"
        border
        class="table"
    ...
    <el-dialog title="路内分配" v-model="viewVisible" width="538px">
      <div class="txtcenter font18 mgb20">居环南路>居环南路西段</div>
      ...
      <template #footer>
        <span class="dialog-footer">
          <el-button @click="viewVisible = false" icon="el-icon-circle-close"
            >取 消</el-button
          >
          <el-button
            type="primary"
...
import { roleData } from "../../../api/index";
