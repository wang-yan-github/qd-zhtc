      ...
      <div class="handle-box">
        ...
        <div class="right-panel">
          ...
          <el-select
            ...
            >
            <el-option value="">全部</el-option>
              <el-option v-for="(item,i) in result.query_park_list" :key="i" :label="item.park_name" :value="item.id"></el-option>
            </el-select>
...
import { InvoicesProvideRecordList,queryAreaData,queryStreetData,queryParkData } from "../../../api/index";;
