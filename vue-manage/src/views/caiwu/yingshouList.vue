    ...
    <div>
        <div class="container">
            ...
            >
                ...
                <el-table-column label="路内" align="center" prop="name">
                </el-table-column>
        ...
        <el-dialog :title="dialogT" v-model="viewVisible" width="1000px">
            <!--<div class="total-box">-->
            <!--<p>订单总量: <el-tag size="small">{{ ordersTotal }}</el-tag></p>-->
            <!--<p>支付总额: <el-tag size="small">{{ amount }}</el-tag></p>-->
            <!--</div>-->
            <el-table
    ...
    export default {
        ...
        setup() {
            ...
            const exportExcel = () => {
                axios({
                    url: File_URL.file_down + "excel/exportPaymentOrder?parkingType=" + parkingType.value
                        ...
                        + "&streetId=" + query.streetId + "&roadId=" + query.roadId + "&paymentType=" + query.paymentType
            ...
            const handleView = (index, row) => {
                ...
                // amount.value = row.amount + "元";
                // ordersTotal.value = row.count + "单";
                if (row.is_union_pay != 1) {
                    dialogT.value = "支付详情的订单";
                } else {
                    dialogT.value = "联合支付的订单";
                }
            };
